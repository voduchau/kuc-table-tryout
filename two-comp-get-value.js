window.addEventListener('DOMContentLoaded', _ => {
  ...
  const renderDropdowns = (cellData, rowData) => {
    ...
    country.addEventListener("change", event => {
      ...
      city.value = "";
      event.detail.value = JSON.stringify({city: city.value, country: country.value});
    })
  ...
  table.addEventListener('change', event => {
    ...
    console.log('Getting values of the dropdowns directly');
  ...
  document.querySelector('#two-comp-get-value').appendChild(table);
});
